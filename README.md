# Resume Analyzer
This project analyzes your resume and score it and provide recommendations against a job description using an integrated LLM model, Gemini-1.5-Flash.<br>
